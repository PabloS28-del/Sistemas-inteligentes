  ...
  >
    ...
    <div>
      ...
      <header class="mb-6">
        ...
        <!-- Botón Canva (opcional por semana) -->
        <div v-if="week.canvaLink" class="mt-3">
          <a
            :href="week.canvaLink"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-600 text-white text-sm font-medium
                  hover:bg-blue-700 transition shadow"
          >
            <!-- pequeño ícono externo opcional -->
