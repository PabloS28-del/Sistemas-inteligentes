          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div class="space-y-3">
                ...
                <a
                  href="https://examen-parcial-si-front.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-primary hover:bg-primary/80 text-white font-semibold transition shadow-lg hover:shadow-xl"
                >
